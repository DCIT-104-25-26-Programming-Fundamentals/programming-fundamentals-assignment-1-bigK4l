...
def view_tasks(tasks):
    """Displays all current tasks with their numbered positions."""
    if not tasks:
...
def delete_task(tasks):
    """Shows tasks and removes a selected task by its list number."""
    if not tasks:
...
def main():
    """Main program loop for managing the to-do list."""
    tasks = []
